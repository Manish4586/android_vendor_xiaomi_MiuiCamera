...
# Package Blobs
PRODUCT_COPY_FILES += \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libavast-utils.so:system/priv-app/MiuiCamera/lib/arm64/libavast-utils.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libavast-vps-interface.so:system/priv-app/MiuiCamera/lib/arm64/libavast-vps-interface.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libavcodec-milink.so:system/priv-app/MiuiCamera/lib/arm64/libavcodec-milink.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libjni_clearsight.so:system/priv-app/MiuiCamera/lib/arm64/libjni_clearsight.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libjni_snapcammosaic.so:system/priv-app/MiuiCamera/lib/arm64/libjni_snapcammosaic.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libjni_snapcamtinyplanet.so:system/priv-app/MiuiCamera/lib/arm64/libjni_snapcamtinyplanet.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libjni_ubifocus.so:system/priv-app/MiuiCamera/lib/arm64/libjni_ubifocus.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libjni_wideselfie.so:system/priv-app/MiuiCamera/lib/arm64/libjni_wideselfie.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera_dbg.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera_dbg.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera_tintless_algo.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera_tintless_algo.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera_tintless_bg_pca_algo.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera_tintless_bg_pca_algo.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_frame_algorithm.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_frame_algorithm.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_is.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_is.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_q3a_core.so:system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_q3a_core.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_stats_algorithm:system/priv-app/MiuiCamera/lib/arm64/libmmcamera2_stats_algorithm.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmm-omxcore.so:system/priv-app/MiuiCamera/lib/arm64/libmm-omxcore.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmorpho_panorama_gp3.so:system/priv-app/MiuiCamera/lib/arm64/libmorpho_panorama_gp3.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libmorpho_sensor_fusion.so:system/priv-app/MiuiCamera/lib/arm64/libmorpho_sensor_fusion.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libscveObjectSegmentation.so:system/priv-app/MiuiCamera/lib/arm64/libscveObjectSegmentation.so \
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libscveObjectSegmentation_stub.so:system/priv-app/MiuiCamera/lib/arm64/libscveObjectSegmentation_stub.so \
    ...
    $(VENDOR_PATH)/system/priv-app/MiuiCamera/lib/arm64/libyuv.so:system/priv-app/MiuiCamera/lib/arm64/libyuv.so